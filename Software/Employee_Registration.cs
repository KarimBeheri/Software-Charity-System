    ...
    public partial class Employee_Registration : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                c.CommandText = "INSERT INTO Emps (id, name, username, email, phone, birthdate, address, gender, password)  VALUES (user_id_seq3.nextval, :name, :username, :email, :phone, :birthdate, :address, :gender, :password)";
